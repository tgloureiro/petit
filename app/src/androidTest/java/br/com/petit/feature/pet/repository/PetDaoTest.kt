...
import br.com.petit.util.MainCoroutineRule
...
class PetDaoTest {
    ...
    @Inject @Named("test_db") lateinit var database: AppDatabase
    ...
    fun adoptPet() = runBlockingTest {
        ...
        petDao.adopt(pet.id, pet.name, pet.pictureUrl, pet.petGender, pet.description)
        assertThat(petDao.getAdoptedPet()?.pet).isEqualTo(pet)
    }*/
